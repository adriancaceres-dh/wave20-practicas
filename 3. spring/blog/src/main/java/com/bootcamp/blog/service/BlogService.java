...
public class BlogService implements IBlogService{
    ...
    public List<EntradaBlogResponseDto> getEntradaBlogResponseDtos(String id) {
        if (id == null) {
            ...
            if(entradaBlogResponseDtos.size() > 0) {
                ...
                //throw new NotFoundException("Blog no encontrado en la base de datos");
                throw new NotFoundException(new MensajeExceptionDTO("Post no encontrado en la base de datos"));
            }
        }
    }
    ...
    public MensajeEntradaBlogResponseDto addEntrada(EntradaBlogRequestDto entradaBlogRequestDto) {
        if( blogRepository.agregarEntradaBlog(
            ...
            throw new AlreadyExistsException("No puedo crear la entrada, estoy haciendo té");
        }
    }
}
