...
import com.bootcamp.blog.exceptions.BookAlreadyExistsException;
import com.bootcamp.blog.exceptions.BookBadRequestException;
import com.bootcamp.blog.exceptions.BookNotFoundException;
...
public class BlogService implements IBlogService{
    ...
    public MensajeEntradaBlogResponseDto addEntrada(EntradaBlogRequestDto entradaBlogRequestDto) {
        if( blogRepository.agregarEntradaBlog(
            ...
            throw new BookAlreadyExistsException("Bad request");
        }
    }
}
