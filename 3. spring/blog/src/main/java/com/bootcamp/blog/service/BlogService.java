...
public class BlogService implements IBlogService{
    ...
    public MensajeEntradaBlogResponseDto addEntrada(EntradaBlogRequestDto entradaBlogRequestDto) {
        if(blogRepository.getEntradaById(entradaBlogRequestDto.getId()).isPresent()){
            throw new IdNotFoundException(new IdNotFoundResponseDto(entradaBlogRequestDto.getId(), "El blog ya se encuentra registrado"));
        } else
