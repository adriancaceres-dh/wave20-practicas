...
public class Traductor {
    private String devolverChar(String posicion){
    ...
    public String codigoMorse(@RequestParam(value = "palabra", defaultValue = "")String palabra){
        String decodificado="";
        String[] textoSeparado = palabra.split(" ");
        for(String texto: textoSeparado){
            String equivalencia = devolverChar(texto);
            decodificado += equivalencia;
        }
        return decodificado;
    }

    //Optimizar para que separe entre palabras (luego)
