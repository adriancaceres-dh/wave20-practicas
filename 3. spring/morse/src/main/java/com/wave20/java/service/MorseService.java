...
public class MorseService {
    ...
    public static String decodificarMorse(String codificado) {
        String[] morseEntero = codificado.split("   ");
        String result = "";
        for (String palabra : morseEntero) {
             result += decodificarPalabra(palabra) + " ";
        }
        return  result;
    }

    public static String decodificarPalabra(String palabra) {
        StringBuilder decodificado = new StringBuilder();
        // Necesitamos separarlo por espacios
        String[] morse = palabra.split(" ");
