...
public class ItemPriceController {
	...
	@GetMapping("/items/prices-usd/{itemId}")
	public Double getItemPriceInUsd(@PathVariable String itemId) throws ParseException, RestException {
		return itemsService.getItemPriceInUsd(itemId);
	}
}
