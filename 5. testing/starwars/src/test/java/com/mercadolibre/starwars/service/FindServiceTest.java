...
class FindServiceTest {
  @Mock
  private CharacterRepositoryImpl characterRepositoryMock;
  ...
  void testFind() {
    ...
    CharacterDTO characterDTO = CharacterDTO.builder()
            ...
            .skin_color("fair")
            .build();
    when(characterRepositoryMock.findAllByNameContains("Luke")).thenReturn(List.of(characterDTO));
    ...
    assertEquals(characterDTO.getSkin_color(), result.get(0).getSkin_color());
    verify(characterRepositoryMock, times(1)).findAllByNameContains("Luke");
  }
}
