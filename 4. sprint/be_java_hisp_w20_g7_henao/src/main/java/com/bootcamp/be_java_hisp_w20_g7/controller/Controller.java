...
public class Controller {
    ...
    ResponseEntity<String> promoPostAdd(@RequestBody PromoPostCreateDto post) {
    ...
    public ResponseEntity<UserPromoPostCountDto> countPromoPost(@RequestParam int user_id) {
        return new ResponseEntity<>(iUserService.countPromoPosts(user_id), HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/list")
    public ResponseEntity<UserPromoPostDto> promoPostUser(@RequestParam int user_id) {
        return new ResponseEntity<>(postService.promoPostUser(user_id), HttpStatus.OK);
    }
