...
public interface IUserService {
     ...
     *
     * @param userId: id del usuario
     * @return UserPromoPostCountDto : retorna la información del ususario mas el numero de posts en promocion que tiene
     */
    UserPromoPostCountDto countPromoPosts(int userId);
