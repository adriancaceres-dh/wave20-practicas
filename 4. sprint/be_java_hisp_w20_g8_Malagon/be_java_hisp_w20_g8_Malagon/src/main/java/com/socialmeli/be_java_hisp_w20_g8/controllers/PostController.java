...
public class PostController {
    ...
    public ResponseEntity<?> GetNumberOfProductsOnPromotion(@RequestParam String user_id){
      return new ResponseEntity<>(postService.CountProductsWithDiscount(user_id),HttpStatus.OK);
