...
De conformidad a la historia de usuario US 0002, donde se obtiene la cantidad de usuarios que siguen a un determinado vendedor, se plantea un endpoint (US 0012) que retorne la cantidad de vendedores que sigue un usuario.

| User Story  | Method   | Route   | 
| :---        |    :----:|    :---: | 
| SU0012  | GET  | /users/{userId}/followed/count |
