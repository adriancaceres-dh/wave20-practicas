...
public class UserController {
    ...
    public ResponseEntity<ResponseMessageDTO> newFollow(@PathVariable int userId, @PathVariable int userIdToFollow){
        try{
    ...
    public ResponseEntity<ResponseMessageDTO> unfollowC(@PathVariable int userId, @PathVariable int userIdToUnfollow) {
        try {
