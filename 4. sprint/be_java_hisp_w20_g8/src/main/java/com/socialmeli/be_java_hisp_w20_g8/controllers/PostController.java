...
public class PostController {
    ...
    public ResponseEntity<ResponsePostDTO> findAllPostsByIdUser(@PathVariable int userId){
        return new ResponseEntity<>(postService.findSellersByIdUser(userId), HttpStatus.OK);
    }
}
