...
public interface IServicePublication {
    ...
    PromoPublicationListDTO getPromoPublications(Integer userId);
    PromoPublicationListDTO getPromoPublicationsInRangePrice(Integer userId, Double from , Double to, String order);
