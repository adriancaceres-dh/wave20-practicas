...
import com.bootcamp.be_java_hisp_w20_ramosruiz.dto.response.*;
import com.bootcamp.be_java_hisp_w20_ramosruiz.dto.response.UserFollowedResponseDto;
import com.bootcamp.be_java_hisp_w20_ramosruiz.dto.response.UserResponseDto;
...
import com.bootcamp.be_java_hisp_w20_ramosruiz.repository.interfaces.IUserRepository;
...
public class UserService implements IUserService {
    ...
    @Override
    public void validateUserIsSellerById(int id) {
        User user = userRepository.getUserById(id);
        validateUserIsSeller(user);
    }
    ...
    public String getUserName(int id) { return userRepository.getUserById(id).getName(); }
}
