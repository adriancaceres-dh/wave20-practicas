...
- Se guardaran los post promo dentro de la misma lista de publicaciones generales, para solo tener un lugar con toda la
información.
- De los requerimientos entregados en la us0012 para el payload se decide omitir el user_id dentro del post, ya que el 
userId de todas las publicaciones es el mismo porque se traen los productos de un vendedor en específico.(Bonus)
- Se añade la colección de Postman (SPRINT-1 API-USER.postman_collection)
