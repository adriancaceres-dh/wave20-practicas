...
public class Controller {
    ...
    ResponseEntity<String> postPromoAdd(@RequestBody PostPromoCreateDto promoPost) {
    ...
    public ResponseEntity<PromoProductsCountDto> countProductPromo(@RequestParam(required = true) int userId) {
    ...
    public ResponseEntity<PromoProductsDto> promoProductsList(@RequestParam(required = true) int userId) {
        return new ResponseEntity<>(postService.promoProductsList(userId), HttpStatus.OK);
    }
