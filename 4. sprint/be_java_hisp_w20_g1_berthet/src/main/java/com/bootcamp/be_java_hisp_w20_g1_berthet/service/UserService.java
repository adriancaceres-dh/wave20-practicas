...
import com.bootcamp.be_java_hisp_w20_g1_berthet.dto.response.*;
import com.bootcamp.be_java_hisp_w20_g1_berthet.dto.response.UserFollowedResponseDto;
import com.bootcamp.be_java_hisp_w20_g1_berthet.dto.response.UserResponseDto;
...
import com.bootcamp.be_java_hisp_w20_g1_berthet.repository.interfaces.IUserRepository;
...
public class UserService implements IUserService {
    ...
    @Override
    public User validateUserExistById(int id) {
        User user = userRepository.getUserById(id);
        validateUserExist(user);
        return user;
    }
