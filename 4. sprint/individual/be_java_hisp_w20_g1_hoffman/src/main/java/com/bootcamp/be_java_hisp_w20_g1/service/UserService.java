...
public class UserService implements IUserService {
    ...
    @Override
    public List<UserResponseDto> getUserListDto(Set<Integer> users, String order) {
    ...
    @Override
    public UserResponseDto getUserDtoById(int id) {
        User user = userRepository.getUserById(id);
        if (user != null) return mapper.map(user, UserResponseDto.class);
        return null;
    }
