...
public class PostMapper {
    ...
    public Post toPost(PromoPostRequestDTO promoPostRequestDTO) {
        Product product = productMapper.toProduct(promoPostRequestDTO.getProduct());

        Category postCategory = getPostCategoryByCodeOrThrow(promoPostRequestDTO.getCategory());

        return new Post(promoPostRequestDTO.getDate(),
                product,
                postCategory,
