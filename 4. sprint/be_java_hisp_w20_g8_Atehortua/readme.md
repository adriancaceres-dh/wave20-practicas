...
- Se realizo el bonus propuesto en el playground, en el cual se tiene como respuesta la informacion del vendedor con los post que tiene promocion, pero aqui no se muestra el detalle del producto.