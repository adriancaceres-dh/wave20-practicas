...
import com.socialmeli.be_java_hisp_w20_g8.dto.BonusDTO;
import com.socialmeli.be_java_hisp_w20_g8.dto.PostRequestDTO;

import com.socialmeli.be_java_hisp_w20_g8.dto.PromoRequestDTO;
...
public interface IPostService {
    ...
    boolean createPostPromo(PromoRequestDTO promoRequestDTO);

    BonusDTO promoProducts(int userId);
}
