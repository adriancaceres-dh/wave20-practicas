package com.bootcamp.be_java_hisp_w20_g2_alderete.utils;
...
import com.bootcamp.be_java_hisp_w20_g2_alderete.repository.PostRepository;
...
public class LoadExampleData {
    ...
    private void initializePostsAndProducts() {
        ...
        Product auriculares = new Product(1002, "Auriculares", "Gamer", "Redragon", "Negro con luz RGB", "");
        ...
        Post postConPromo = new Post(LocalDate.now(), auriculares, categoryRepository.findByCode(125).get(), 13500, ale, true, 0.03);
