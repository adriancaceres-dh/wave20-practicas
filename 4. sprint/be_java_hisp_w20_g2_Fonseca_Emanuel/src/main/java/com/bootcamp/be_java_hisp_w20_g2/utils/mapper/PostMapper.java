...
public class PostMapper {
    ...
    public Post toPromoPost(PostPromoDTO postDTO) {
        Product product = productMapper.toProduct(postDTO.getProduct());

        Category postCategory = getPostCategoryByCodeOrThrow(postDTO.getCategory());

        return new Post(postDTO.getDate(), product, postCategory, postDTO.getPrice(), postDTO.isHasPromo(), postDTO.getDiscount());
    }
