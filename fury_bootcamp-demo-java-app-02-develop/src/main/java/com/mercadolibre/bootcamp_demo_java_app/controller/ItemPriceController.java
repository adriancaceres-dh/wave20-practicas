...
public class ItemPriceController {
	...
	@GetMapping("/usdprices/{itemId}")
	public Double getItemUSDPrice(@PathVariable String itemId) throws ParseException, RestException {
		return itemsService.getItemUSDPrice(itemId);
	}
}
