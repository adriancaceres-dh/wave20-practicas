...
public class ClientService implements IClientService {
    ...
    public ClientDTO saveEntity(ClientDTO clientDTO) {
        ...
        var entityPerson = personRepository.findById(clientDTO.getPerson().getId()).get(); // Si quiero darle una respuesta al cliente de lo que se creo, necesito ir y buscar los datos a la db.
    ...
    public List<ClientDTO> getAllEntities() {
        ...
        return entities.stream().map(e -> mapper.map(e, ClientDTO.class)).collect(Collectors.toList());
    }
