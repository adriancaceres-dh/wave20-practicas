...
public class JoyaService implements IJoyaService{
    ...
    public String saveJoya(Joya joya) {
       Joya joyaguard = joyaRepo.save(joya);

       return "Joya guardada correctamente con id: " + joyaguard.getNro_id();
    }
    ...
    public String deleteJoya(Long id) {
        ...
        return "Joya con id " + joyaOriginal.getNro_id() + " dada de baja para la venta correctamente";
    }
    ...
    public String editJoya(Long id_modificar, Joya joya_modif) {
        ...
        this.saveJoya(joyaOriginal);
        return "Modificaciones guardadas correctamente en la joya con id:  " + joyaOriginal.getNro_id();
