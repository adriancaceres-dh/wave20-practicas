...
public class ClientController {
    ...
    @GetMapping("/prueba/{dni}")
    public ResponseEntity<List<CantInvoicesPerPersonTemplate>> metodoPrueba(@PathVariable String dni){
        return ResponseEntity.ok(clientService.findby());
    }
}
