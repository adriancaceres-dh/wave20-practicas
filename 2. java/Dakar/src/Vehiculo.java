...
public abstract class Vehiculo {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(vehiculo.velocidad, velocidad) == 0 &&
                Double.compare(vehiculo.aceleración, aceleración) == 0 &&
                Double.compare(vehiculo.anguloDeGiro, anguloDeGiro) == 0 &&
                Double.compare(vehiculo.peso, peso) == 0 &&
