...
public class Main {
    public static void main(String[] args) {
        ...
        int temperaturaMax = temperaturas [0][0];
        int temperaturaMin = temperaturas [0][1];
        ...
        System.out.println(menorCiudad + " -> " + temperaturaMin);
        System.out.println(mayorCiudad + " -> " + temperaturaMax);
