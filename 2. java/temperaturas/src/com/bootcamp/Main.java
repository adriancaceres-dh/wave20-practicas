...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("La menor temperatura la tuvo " + ciudades[posTempMin] + " con " + tempMinima);
        System.out.println("La mayor temperatura la tuvo " + ciudades[posTempMax] + " con " + tempMaxima);
    }
}