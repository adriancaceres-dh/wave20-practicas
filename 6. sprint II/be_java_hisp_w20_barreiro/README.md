...
| Test                    | Situaciones de entrada                                                             |
|:------------------------|:-----------------------------------------------------------------------------------|
| `newOKPostTest`         | Verifica que se agregue una nueva publicación de forma correcta.                   |
| `newExceptionPostTest`  | Verifica que al agregar una publicación errónea se devuelva una excepción.         |
| `followValidUserTest`   | Verifica que se añada correctamente a la lista de seguidos a un usuario válido.    |
| `unfollowValidUserTest` | Verifica que se elimine correctamente de la lista de seguidos a un usuario válido. |
| `getFollowersCountTest` | Verifica que se devuelva la cantidad de seguidores de forma correcta.              |
| `getFollowedListTest`   | Verifica que se devuelva la lista de seguidos de forma correcta.                   |
| `getFollowersListTest`  | Verifica que se devuelva la lista de seguidores de forma correcta.                 |
