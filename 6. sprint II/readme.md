...
*     US 003: followersOrder(Asc/Desc/Null)OkTest - Verificar que el orden exista.                     Gabriela Stocco
*     US 004: followedOrder(Asc/Desc/Null)OkTest - Verificar el ordenamiento ascendente por nombre.    Tammara Trivelli
...
*     US Individual: addPostIntegrationTest - Verifico que se cree una publicacion correctamente. 
*     US Individual (Bonus): followIntegrationTest - Verifico la funcionalidad de seguir a un vendedor.
