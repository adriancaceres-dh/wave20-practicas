...
import static com.bootcamp.be_java_hisp_w20_g2.util.Utils.addPostsToUser;
...
public class PostIntegrationTest {
    ...
    void addNewProductOK() throws Exception {
        ...
        PostDTO postDTO = Utils.generatePostDTO(user1.getId());
    ...
    public void addNewProductFailsInvalidUserId() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/products/post")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.content().contentType("text/plain;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.content().string("The given userId does not exist."));
