...
Se desarrolla el test integración de la clase UserController contemplando los endpoints :


+ /{userId}/follow/{userIdToUnfollow} 

+ /{userId}/unfollow/{userIdToUnfollow}

+ /{userId}/followed/list

+ /{userId}/followers/list


Probando al menos un caso de fallo en cada uno de estos , logrando así un coverage de 80% de lineas 
al ejecutar todos los test del proyecto , cubriendo lo solicitado en el bonus de la entrega
