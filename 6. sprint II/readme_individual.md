...
|         | US Verificada                                                                    |
|---------|----------------------------------------------------------------------------------|
| TI-0001 | (US-0008) Ver lista de 'Seguidos' Asc Ok  |
| TI-0002 | (US-0001) Poder realizar la acción de “Follow” (seguir) a un determinado vendedor                    |
| TI-0003 | (US-0001) Seguir a un usuario- 'Usuario inexistente'    |
| TI-0004 | (US-0002) Cantidad de usuarios que siguen un vendedor OK                                         |
| TI-0005 | (US-0003) ¿Quién me sigue? OK                          |
| TI-0006 | (US-0003) ¿Quien me sigue? - Usuario no encontrado                                                   |
| TI-0007 | (US-0002) Cantidad de usuarios que siguen a un vendedor - Usuario no encontrado                               |
| TI-0008 | (US-0005) Publicar un producto - product_id < 0                                  |