...
import com.bootcamp.be_java_hisp_w20_g2_espindola.utils.constants.RegexConstants;
...
public class ProductDTO {
    ...
    @Positive(message = "El id_product debe ser mayor a cero.")
    private Integer productId;

    @NotBlank(message = "El campo no puede estar vacío.")
    @Size(max = 40,message = "La longitud del campo name no puede superar los 40 caracteres.")
