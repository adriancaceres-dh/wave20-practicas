...
13. _**[Test de Integración](#-implementación-de-test-integración---individual-)**_
    1. _**[Implementación del Test de integración - Individual](#-implementación-de-test-integración---individual-)**_
    2. _**[Bonus - Desarrollo Individual Extra](#-bonus---desarrollo-individual-extra---)**_
...
Se obtiene un coverage total de 89% en la capa controllers.

## 🧨 Bonus - Desarrollo Individual EXTRA - 2.0 🧨
Se desarrolla la totalidad de los test de integración de la clase _UserController_ y _PostController_ y con eso se llega a un Coverage, de
líneas de 90%, llegando así a la pauta [BONUS](#-bonus---desarrollo-individual-extra---20-).
____
