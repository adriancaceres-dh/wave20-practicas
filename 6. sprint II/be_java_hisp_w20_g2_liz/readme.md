...
Se desarrollan los tests integración de las siguientes funciones: 
- _follow()_. Asociada al endpont _"/users/{userId}/follow/{userIdToFollow}"_
- _unfollowUser()_. Asociada al endpont _"/users/{userId}/unfollow/{userIdToUnfollow}"_

Se consideraron solo los casos exitosos en ambos tests.

## 🧨 Bonus - Desarrollo Individual EXTRA - 2.0 🧨
Con el desarrollo incompleto de los tests de integración solo se logró llegar a una covertura del 71% de las lineas de codigo.
____
