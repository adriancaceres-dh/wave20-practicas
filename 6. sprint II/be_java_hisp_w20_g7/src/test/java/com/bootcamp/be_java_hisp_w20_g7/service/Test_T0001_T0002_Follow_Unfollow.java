...
public class Test_T0001_T0002_Follow_Unfollow {
    ...
    @Test
    @DisplayName("T0001 - Follow already exist exception")
    ...
    @Test
    @DisplayName("T0001 - Follow User follower and followed equals")
    ...
    @Test
    @DisplayName("T0002 - Unfollow not exist exception")
