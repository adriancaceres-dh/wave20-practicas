...
public class TestsUtilsGenerator {
        ...
        public static List<UserModel> ListUsersModelWithFollowers() {
                return List.of(
                                new UserModel(1, "Diana", new ArrayList<Integer>() {
                                        {
                                                add(2);
                                                add(3);
                                        }
                                ...
                                new UserModel(2, "Daniela", new ArrayList<Integer>() {
                                        {
                                                add(1);
                                                add(3);
                                        }
                                ...
                                new UserModel(3, "David", new ArrayList<Integer>() {
                                        {
                                                add(1);
                                                add(2);
                                        }
        ...
        public static List<UserResponseDto> getListUserRespondeDTOWithFollowers() {
                return ListUsersModelWithFollowers().stream()
                                .map(u -> new UserResponseDto(u.getUser_id(), u.getUser_name()))
                ...
                return new ArrayList<>(
                                Arrays.asList(
                                        new PostResponseDTO(1, 1, LocalDate.now().minusDays(4),
                                                        new ProductModel(1, "Silla", "Gamer", "Racer",
