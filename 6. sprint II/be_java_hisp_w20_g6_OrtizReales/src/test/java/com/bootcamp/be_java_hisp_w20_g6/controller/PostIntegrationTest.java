...
public class PostIntegrationTest {
    ...
    void souldSavePost() throws Exception{
         PostRequestDto postRequestDto = new PostRequestDto(1,"24-12-2022",100,
                 new ProductRequestDto(
                         1,"Silla normal", "Gamer", "Racer", "Red Black", "Special Edition"
                 ),
                 1500.50
                 );
    ...
    @Test
    @DisplayName("US0006 - IT0002 Valida que el endPoint /products/followed/1/list devuelva el usuario correcto y un status OK")
