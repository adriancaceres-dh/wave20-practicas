...
|---------|------------|--------------------------------------------------------------------------------------------------------------------------------|
| IT-0001 | US0005    | Verifica que el endPoint ***/products/post*** guarde correctamente el post y devuelva un true con un status OK.                                                   |
| IT-0002 | US-0006   | Verifica que el endPoint ***/products/followed/1/list*** devuelva un status OK.                                           |
| IT-0003 | US-0003    | Verifica que el endPoint ***/users/1/followers/list*** devuelva un status OK.                                              |
